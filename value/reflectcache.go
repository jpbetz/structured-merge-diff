...
// UnstructuredStringConvertable defines how a type can be converted directly to a unstructured string.
...
type UnstructuredStringConvertable interface {
	...
	// ToUnstructuredString returns the unstructured string representation and true, or false for a nil
...
// GetFrom accesses field identified by this FieldCacheEntry from the provided struct and returns it.
...
func TypeReflectEntryOf(t reflect.Type) TypeReflectCacheEntry {
	...
	if t.Name() == "Quantity" {
		fmt.Printf("getStringConvertable: %s, entry: %#+v\n", t.Name(), record)
	}
	return record
}
...
func (e TypeReflectCacheEntry) ToUnstructured(sv reflect.Value) (interface{}, error) {
	...
	entry := TypeReflectEntryOf(sv.Type())
...
func (e TypeReflectCacheEntry) FromUnstructured(sv, dv reflect.Value) error {
	...
	// UnstructuredStringConvertable.ToUnstructuredString provides.
	st := dv.Type()
...
func (e TypeReflectCacheEntry) getStringConvertable(v reflect.Value) (UnstructuredStringConvertable, bool) {
